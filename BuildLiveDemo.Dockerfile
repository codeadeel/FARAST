...
# ==============================
# docker run --rm -it \
#     -e meshModel=/home/faceMesh.task                  # [ Optional : Face Mesh Model Absolute Path ] \
...
RUN pip3 install opencv-python-headless==4.7.0.68 streamlit==1.21.0 streamlit-webrtc==0.45.1 altair==4.2.2 grpcio==1.56.2 bounding-box==0.1.3 mediapipe==0.10.3
...
WORKDIR /home
COPY ./Resources/faceMesh.task ./faceMesh.task
