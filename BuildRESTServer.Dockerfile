...
#
# =====================================================================
# | FACE DETECTION, RECOGNITION & TRACKING INFERENCE SERVER (REST API)|
# =====================================================================
# 
# This Dockerfile is used to build model inference server for REST API based Face Detection, Recogntion & Tracking.
# 
# Quick Command to Build Inference Server
# =======================================
# docker build -t face:restserver -f BuildRestServer.Dockerfile .
#
...
#     -e apiRoute=/camo             # [ Optional : Inference route for REST API ] \
#     face:restserver
#
# Main Build Script
# =================
